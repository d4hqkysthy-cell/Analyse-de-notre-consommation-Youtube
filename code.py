...
# On cherche et on charge le fichier des abonnements
...
if fichiers_abos:
    ...
    # 2. Fonction de vérification : Abonné ou non ?
...
# SÉCURITÉ : On recrée la colonne 'Chaine' car elle a disparu du tableau
# (Il faut le faire AVANT de filtrer l'année 2025 pour que la colonne soit copiée)
df['Chaine'] = df['subtitles'].apply(lambda x: x[0].get('name') if isinstance(x, list) and len(x) > 0 else "Inconnu")
